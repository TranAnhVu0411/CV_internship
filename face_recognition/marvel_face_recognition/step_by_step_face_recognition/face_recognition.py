...
if __name__ == '__main__':
    ...
    face_recognition.face_recognition_image(os.path.join(sample_path, "test3.jpeg"), 
                                             save_path)
    # face_recognition.face_recognition_video(os.path.join(sample_path, "/Users/trananhvu/Documents/CV/CV_internship/face_recognition/marvel_face_recognition/sample/Robert Downey Jr  Scarlett Johansson Mark Ruffalo Chris Hemsworth Interview.mp4"))